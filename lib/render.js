...
function _render(container, changesetId, result) {
  ...
  // Add `tagsCount` to feature properties
    ...
    document.querySelector('.cmap-time').textContent =
    '(' + moment(date).fromNow() + ')';
    ...
    document.querySelector('.cmap-c-link-osm').href =
    'https://openstreetmap.org/changeset/' + changesetId;
    document.querySelector('.cmap-c-link-osmcha').href =
    'https://osmcha.mapbox.com/' + changesetId + '/';
    document.querySelector('.cmap-c-link-achavi').href =
    'https://overpass-api.de/achavi/?changeset=' + changesetId;
    document.querySelector('.cmap-c-link-osmhv').href =
    'http://osmhv.openstreetmap.de/changeset.jsp?id=' + changesetId;
    document.querySelector('.cmap-c-link-josm').href =
    'http://127.0.0.1:8111/import?url=http://www.openstreetmap.org/api/0.6/changeset/' +
    changesetId +
    '/download';
    document.querySelector('.cmap-c-link-id').href =
    ...
    document.querySelector('.cmap-u-link-osm').href =
    'https://openstreetmap.org/user/' + userName;
    document.querySelector('.cmap-u-link-hdyc').href =
    'http://hdyc.neis-one.org/?' + userName;
    document.querySelector('.cmap-u-link-disc').href =
    'http://resultmaps.neis-one.org/osm-discussion-comments?uid=' + userId;
    document.querySelector('.cmap-u-link-comm').href =
...
function renderHTML(container) {
  // var x = document.getElementById(container).appendChild('div'); // container.appendChild('div');
    ...
    <div>
      ...
      <div className="xcmap-sidebar" style={{ display: 'none' }} />
  ...
  //Info markup
    ...
    const sidebsar = (
    <div className="cmap-sidebar" style={{ display: 'none' }}>
      <section className="cmap-changeset-section cmap-fill-light cmap-pt3">
        <h6 className="cmap-heading">
          Changeset:
          <em className="cmap-changeset-id">47876121</em>
          <small
            className="cmap-time"
            className="Mon Apr 17 2017 21:18:58 GMT+0530 (IST)"
          >
            (a month ago)
          </small>
        </h6>
        <ul className="cmap-hlist">
          <li>
            <a
              ...
              href="https://openstreetmap.org/changeset/47876121"
            >
              OSM
            </a>
          </li>
          <li>
            <a
              ...
              href="https://osmcha.mapbox.com/47876121/"
            >
              OSMCha
            </a>
          </li>
          <li>
            <a
              ...
              href="https://overpass-api.de/achavi/?changeset=47876121"
            >
              Achavi
            </a>
          </li>
          <li>
            <a
              ...
              href="http://osmhv.openstreetmap.de/changeset.jsp?id=47876121"
            >
              OSM HV
            </a>
          </li>
          <li>
            <a
              ...
              href="http://127.0.0.1:8111/import?url=http://www.openstreetmap.org/api/0.6/changeset/47876121/download"
            >
              JOSM
            </a>
          </li>
          <li>
            <a
              ...
              href="http://preview.ideditor.com/release#map=15/-25.92644595/-49.17212455"
            >
              iD
            </a>
          </li>
      ...
      <section className="cmap-user-section cmap-fill-light cmap-pb3">
        <h6 className="cmap-heading">
          User: <em className="cmap-user-id">luisgustavo1968</em>
        </h6>
        <ul className="cmap-hlist">
          <li>
            <a
              ...
              href="https://openstreetmap.org/user/luisgustavo1968"
            >
              OSM
            </a>
          </li>
          <li>
            <a
              ...
              href="http://hdyc.neis-one.org/?luisgustavo1968"
            >
              HDYC
            </a>
          </li>
          <li>
            <a
              ...
              href="http://resultmaps.neis-one.org/osm-discussion-comments?uid=701711"
            >
              Discussions
            </a>
          </li>
          <li>
            <a
              ...
              href="http://resultmaps.neis-one.org/osm-discussion-comments?uid=115894701711&amp;commented"
            >
              Comments
            </a>
          </li>
      ...
      <section className="cmap-filter-action-section cmap-pt3">
        <h6 className="cmap-heading">Filter by action</h6>
        <ul className="cmap-hlist">
          <li>
    ...
    elt(
      'section',
      { class: 'cmap-changeset-section cmap-fill-light cmap-pt3' },
      elt(
        'h6',
        { class: 'cmap-heading' },
        'Changeset: ',
        ...
        elt(
          ...
          elt(
            'a',
              {
                  target: '_blank',
                  class: 'cmap-hlist-item cmap-noselect cmap-pointer cmap-c-link-osm'
              },
            'OSM'
          )
        ),
        elt(
          ...
          elt(
            'a',
              {
                  target: '_blank',
                  class: 'cmap-hlist-item cmap-noselect cmap-pointer cmap-c-link-osmcha'
              },
            'OSMCha'
          )
        ),
        elt(
          ...
          elt(
            'a',
              {
                  target: '_blank',
                  class: 'cmap-hlist-item cmap-noselect cmap-pointer cmap-c-link-achavi'
              },
            'Achavi'
          )
        ),
        elt(
          ...
          elt(
            'a',
              {
                  target: '_blank',
                  class: 'cmap-hlist-item cmap-noselect cmap-pointer cmap-c-link-osmhv'
              },
            'OSM HV'
          )
        ),
    ...
    elt(
      'section',
      { class: 'cmap-user-section cmap-fill-light cmap-pb3' },
      elt(
        'h6',
        { class: 'cmap-heading' },
        'User: ',
        ...
        elt(
          ...
          elt(
            'a',
              {
                  target: '_blank',
                  class: 'cmap-hlist-item cmap-noselect cmap-pointer cmap-u-link-osm'
              },
            'OSM'
          )
        ),
        elt(
          ...
          elt(
            'a',
              {
                  target: '_blank',
                  class: 'cmap-hlist-item cmap-noselect cmap-pointer cmap-u-link-hdyc'
              },
            'HDYC'
          )
        ),
        elt(
          ...
          elt(
            'a',
              {
                  target: '_blank',
                  class: 'cmap-hlist-item cmap-noselect cmap-pointer cmap-u-link-disc'
              },
            'Discussions'
          )
        ),
        elt(
          ...
          elt(
            'a',
              {
                  target: '_blank',
                  class: 'cmap-hlist-item cmap-noselect cmap-pointer cmap-u-link-comm'
              },
            'Comments'
          )
        )
    ...
    elt(
      'section',
      { class: 'cmap-filter-action-section cmap-pt3' },
      ...
      elt(
        ...
        elt(
          ...
          elt(
            'label',
            { class: 'cmap-hlist-item cmap-noselect cmap-pointer' },
            elt('input', {
                type: 'checkbox',
                value: 'added',
                checked: true,
            ...
            elt('span', {
                class: 'cmap-color-box cmap-color-added'
            })
          )
        ),
        elt(
          ...
          elt(
            ...
            elt('span', {
                class: 'cmap-color-box cmap-color-modified-old'
            }),
            elt('span', { class: 'cmap-unicode' }, '→'),
            elt('span', {
                class: 'cmap-color-box cmap-color-modified-new'
            })
          )
        ),
        elt(
          ...
          elt(
            ...
            elt('span', {
                class: 'cmap-color-box cmap-color-deleted'
            })
          )
        )
      )
    ...
    elt(
      'section',
      { class: 'cmap-filter-type-section' },
    ...
    elt(
      'section',
      { class: 'cmap-map-style-section cmap-pb3' },
