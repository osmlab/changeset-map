          ...
          <ul className="cmap-hlist">
            <li>
              <a
                ...
                href={`${config.osmBase}/changeset/${changesetId}`}
              >
                OSM
              </a>
            </li>
            ...
            <li>
              <a
                ...
                href={`http://127.0.0.1:8111/import?url=${config.osmBase}/api/0.6/changeset/${changesetId}/download`}
              >
                JOSM
              </a>
            </li>
            <li>
              <a
                ...
                href={`${config.osmBase}/edit?editor=id&#map=15/${center.lat}/${center.lng}`}
              >
                iD
              </a>
            </li>
          ...
          >
            <li>
              <a
                ...
                href={`${config.osmBase}/user/${userName}`}
              >
                OSM
              </a>
            </li>
